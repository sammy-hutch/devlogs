...
### 🎮 Video Games
- [dungeon-crawler](https://github.com/sammy-hutch/dungeon-crawler): Pygame. dungeon crawler game run code and data. Inspired by Dungeon Crawler Stone Soup
- [in-orbit](https://github.com/sammy-hutch/in-orbit): Godot. Single-player survival on a space station. Collab with [@dj3nt-sux](https://github.com/dj3nt-sux)
- [space-invasion](https://github.com/sammy-hutch/space-invasion): Godot. Spirit Island gameplay with a Twilight Imperium Theme
- [space4](https://github.com/sammy-hutch/space4): Godot. 4x sci-fi strategy game

### ♟️ Boardgames
- [civ_builder](https://github.com/sammy-hutch/civ_builder): Deckbuilder. rules and data for civ builder boardgame
